        ...
        <div className="max-w-7xl mx-auto grid md:grid-cols-4 gap-12 mb-20">
          ...
          <div>
            ...
            <div className="flex gap-4">
              <a href={EXPERT.instagram} target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-xl glass flex items-center justify-center hover:text-emerald-400 transition-all"><Instagram size={20} /></a>
              <a href={EXPERT.facebook} target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-xl glass flex items-center justify-center hover:text-emerald-400 transition-all"><Facebook size={20} /></a>
            </div>
          </div>
        </div>
